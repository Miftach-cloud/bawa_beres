            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="rounded-2xl bg-white p-5 border border-slate-200 shadow-xs space-y-3">
                    <div class="flex items-center justify-between border-b border-slate-100 pb-2.5">
                        ...
                        <a href="{{ route('admin.customers.show', $order->customer) }}" class="inline-flex items-center text-[11px] text-amber-600 hover:underline font-semibold">
                            <span>Buka Profil</span>
                            <x-icon name="arrow-right" class="w-3 h-3 ml-0.5 text-amber-600" />
                        </a>
                    </div>
                    <div>
