                                ...
                                @if ($payment->isWaitingVerification())
                                    <div class="inline-flex items-center gap-1.5">
                                        ...
                                        <button 
                                            ...
                                            class="inline-flex items-center rounded-lg bg-rose-50 border border-rose-200 px-2.5 py-1 text-xs font-semibold text-rose-700 hover:bg-rose-100 cursor-pointer"
                                        >
                                            <span>✕ Tolak</span>
                                        </button>
                                    </div>
