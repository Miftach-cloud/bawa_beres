...
>
    @switch($name)
        ...
        @case('surveillance')
            <path d="M2 18h4" />
            <path d="M4 18v-4l4-3" />
            <rect x="8" y="7" width="10" height="6" rx="1.5" transform="rotate(15 13 10)" />
            <path d="m18 8.5 3.5-1.5v6L18 11.5" />
            <line x1="7" y1="6" x2="19" y2="9.5" />
        ...
        @case('whatsapp')
            ...
            <path d="M8.5 9.5c.3-.6.6-.6.9-.6h.7c.2 0 .5.1.6.4l1.1 2.6c.1.3.1.5-.1.7l-.5.6c-.2.2-.3.4-.2.7.5 1.1 1.4 2 2.5 2.5.3.1.5 0 .7-.2l.6-.5c.2-.2.4-.2.7-.1l2.6 1.1c.3.1.4.4.4.6v.7c0 .3 0 .6-.6.9-.7.3-2.1.2-4.1-.7-2.3-1-4.2-2.9-5.2-5.2-.9-2-1-3.4-.7-4.1z" />
            @break
